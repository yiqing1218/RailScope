...
map.on('load',()=>{if(map.getLayer('metro-station-area')){map.removeLayer('metro-station-area');map.addLayer({id:'metro-station-area-fill',type:'fill',source:'metroStationAreas',minzoom:12,paint:{'fill-color':'#38bdf8','fill-opacity':.16}});map.addLayer({id:'metro-station-area-outline',type:'line',source:'metroStationAreas',minzoom:12,paint:{'line-color':'#0ea5e9','line-width':2,'line-opacity':.95}})}});
</script></body></html>"""
